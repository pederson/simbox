...
// inspectors
void SimulationDataHDF::print_summary() const{

}

const Mesh & SimulationDataHDF::mesh() const{
	return *m_mesh;
}

vector<double> SimulationDataHDF::time() const{
	return m_time;
}

vector<string> SimulationDataHDF::nodefields() const{
	return m_nodefields;
}
...
const double * SimulationDataHDF::get_nodefield(string fld, unsigned int tind) const{
	return nullptr;
}

const double * SimulationDataHDF::get_nodefield(string fld, double time) const{
	return nullptr;
}

const double * SimulationDataHDF::get_cellfield(string fld, unsigned int tind) const{
	return nullptr;
}

const double * SimulationDataHDF::get_cellfield(string fld, double time) const{
	return nullptr;
}

const double * SimulationDataHDF::get_transient(string tr) const{
	return nullptr;
}


bool SimulationDataHDF::field_exists(string f) const{
...
void SimulationDataHDF::add_nodefield(string fld){
...
void SimulationDataHDF::add_transient(string tr){
...
void SimulationDataHDF::set_nodefield(string fld, unsigned int tind, const double * data){
	// copy to buffer
	if(!field_exists(fld)){
...
void SimulationDataHDF::set_nodefield(string fld, double t, const double * data){
...
void SimulationDataHDF::set_cellfield(string fld, double t, const double * data){
	set_cellfield(fld, get_time_index(t), data);
}

void SimulationDataHDF::set_transient(string fld, const double * data){
	// copy to buffer
...
void SimulationDataHDF::write_HDF5_mesh(){
...
void SimulationDataHDF::write_HDF5_time(){
...
unsigned int SimulationDataHDF::get_time_index(double timep){
...
void SimulationDataHDF::write_XDMF(){
